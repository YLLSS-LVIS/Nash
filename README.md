...
The Nash codebase is intended for public auditing and research on the Nash exchange. Due to legal reasons, please *do not deploy any software in this repository with real money.*

## About Nash
Nash is the official exchange in the for bounded-resolution, fully-collateralised, cash-settled futures contracts, more commonly known as event contracts, prediction contracts, or binary options.
